...
write.csv(SE_final_annotated,file="rMats_results/SE_filtered_annotated.csv")
...
write.csv(MXE_final_annotated,file="rMats_results/MXE_filtered_annotated.csv")
...
write.csv(RI_final_annotated,file="rMats_results/RI_filtered_annotated.csv")
...
write.csv(A5SS_final_annotated,file="rMats_results/A5SS_filtered_annotated.csv")
...
write.csv(A3SS_final_annotated,file="rMats_results/A3SS_filtered_annotated.csv")
...
write.csv(rmats_summary,file="rMats_results/rmats_summary.csv")
