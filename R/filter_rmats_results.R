...
##
## Purpose of script: To filter the output from the rMats algorithm
##
## Author: NIBRT
##
...
save(SE_all_results, SE_coverage_filt, SE_FDR_filt, SE_PSI_filt, SE_final_annotated, file = "rmats/filtered/r_data_files/SE_filtered_annotated.rData")
write.csv(SE_final_annotated, file = "rmats/filtered/SE_filtered_annotated.csv")

MXE_all_results <- read.table("rmats/MXE.MATS.JC.txt",
  header = T,
  sep = "\t",
  row.names = 1
)
...
save(MXE_all_results, MXE_coverage_filt, MXE_FDR_filt, MXE_PSI_filt, MXE_final_annotated, file = "rmats/filtered/r_data_files/MXE_filtered_annotated.rData")
write.csv(MXE_final_annotated, file = "rmats/filtered/MXE_filtered_annotated.csv")


RI_all_results <- read.table("rmats/RI.MATS.JC.txt",
  header = T,
  sep = "\t",
  row.names = 1
)
...
save(RI_all_results, RI_coverage_filt, RI_FDR_filt, RI_PSI_filt, RI_final_annotated, file = "rmats/filtered/r_data_files/RI_filtered_annotated.rData")
write.csv(RI_final_annotated, file = "rmats/filtered/RI_filtered_annotated.csv")

A5SS_all_results <- read.table("rmats/A5SS.MATS.JC.txt",
  header = T,
  sep = "\t",
  row.names = 1
)
...
save(A5SS_all_results, A5SS_coverage_filt, A5SS_FDR_filt, A5SS_PSI_filt, A5SS_final_annotated, file = "rmats/filtered/r_data_files/A5SS_filtered_annotated.rData")
write.csv(A5SS_final_annotated, file = "rmats/filtered/A5SS_filtered_annotated.csv")


A3SS_all_results <- read.table("rmats/A3SS.MATS.JC.txt",
  header = T,
  sep = "\t",
  row.names = 1
)
...
save(A3SS_all_results, A3SS_coverage_filt, A3SS_FDR_filt, A3SS_PSI_filt, A3SS_final_annotated, file = "rmats/filtered/r_data_files/A3SS_filtered_annotated.rData")
write.csv(A3SS_final_annotated, file = "rmats/filtered/A3SS_filtered_annotated.csv")
...
write.csv(rmats_summary, file = "rmats/filtered/rmats_summary.csv")
