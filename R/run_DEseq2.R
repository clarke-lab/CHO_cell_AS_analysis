...
cell_type <- c("TS","TS","TS","TS", "NTS","NTS","NTS","NTS")
...
sig_de_results <-subset(de_results,
...
biomart.out<-getBM(attributes=c('ensembl_gene_id','entrezgene_id',
...
write.csv(sig_de_results,file="differential_expression/DESeq2_results/TS_v_NTS.csv", row.names=T)
save(list=ls(), file="differential_expression/DESeq2_results/TS_v_NTS.RData")
save(sig_de_results, file="differential_expression/DESeq2_results/sig_de_results.RData")
